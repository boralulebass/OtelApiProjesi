...
namespace HotelProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20230621133140_mig_bookingcitycountry")]
    partial class mig_bookingcitycountry
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    ...
                    b.Property<int>("MessageCategory2ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.MessageCategory2", b =>
                {
                    b.Property<int>("MessageCategory2ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MessageCategory2ID"), 1L, 1);

                    b.Property<string>("MessageCategory2Name")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MessageCategory2ID");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concrete.MessageCategory2", "MessageCategory2")
                        .WithMany("Contacts")
                        .HasForeignKey("MessageCategory2ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MessageCategory2");
                });
